  ...
  const getItems = useCallback(() => {
    return VideosEvent.map((e) => {
      ...
      return (
        ...
        >
          <div className="relative group cursor-pointer w-[150px] h-[150px] bg-white p-2 rounded-lg overflow-hidden">
            <video
                    ...
                    <>
                        ...
                        <div className="mx-auto py-2">
                          <div className="flex space-x-3 overflow-x-auto pb-2">
                            {data?.photos?.map((e, i) => (
                              ...
                              >
                                <div className="relative group w-[150px] h-[150px] flex rounded-lg justify-center p-2 mx-1 bg-white  overflow-hidden">
                                  <img
                      ...
                      {/* {(photoIndex === 0 || photoIndex) &&
                        data?.photos[photoIndex] && (
                          ...
                          spaceBetween={10}
                          navigation={true}
                          thumbs={{ swiper: photoIndex && !photoIndex.destroyed ? photoIndex : null }}
                          modules={[Navigation, Thumbs]}
                        >
                          {data?.photos && data.photos?.map((e, i) => {
                         return  ( <SwiperSlide key={i}>
                           ...
                           <Lightbox
                            mainSrc={
                              s3Url + "/" + data?.photos[photoIndex]?.url
                            }
                            imageCaption  ={data?.photos[photoIndex]?.description}
                            nextSrc={
                              s3Url +
                              "/" +
                              data?.photos[
                  ...
                  <div className="media-upload-holder">
                    ...
                    {company?.photos?.length > 0 && (
                      <>
                          ...
                          <div className="mx-auto py-2">
                            <div className="flex space-x-3 overflow-x-auto pb-2">
                              {data?.companydetail?.photos?.map((e, i) => (
                                ...
                                >
                                  <div className="relative w-[150px] h-[150px] group flex rounded-lg justify-start p-2 mx-1 bg-white overflow-hidden">
                                    <img
                                      className="block h-full w-full rounded-lg"
                                      src={s3Url + "/" + e?.url}
                                      alt={e.description}
                        ...
                        {/* {(photoIndex === 0 || photoIndex) &&
                          data?.companydetail?.photos[photoIndex] && (
                            <Lightbox
                              mainSrc={
                                s3Url + "/" + data?.photos[photoIndex]?.url
                              }
...
<SwiperSlide>
  ...
  />
  <p>{data?.photos[photoIndex]?.description}</p>
</SwiperSlide>
</Swiper> */}