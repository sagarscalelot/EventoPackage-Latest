                  ...
                  <div className="mx-auto py-2">
                    <div className="-m-1 flex md:-m-2">
                      {data?.photos?.map((e, i) => (
                        ...
                        >
                          <div className="w-[150px] h-[150px] flex rounded-lg justify-center p-2 mx-1 bg-white">
                            <img
                ...
                <div className="w-full flex flex-wrap">
                  <div className="w-full md:w-1/2 p-2">
                    <div className="w-full p-3.5 bg-white rounded flex items-center space-x-4">
                      ...
                      <div className="w-full break-all outline-none text-japaneseIndigo font-semibold">
                        {socials?.facebook}
                      </div>
