...
import { removeEvent } from '../../../Pages/Dashboard/Event/AddPlace/eventAddPlaceSlice';

function DeleteEvent({ handleClose }) {
    const intl = useIntl();
                    ...
                    <div className="bg-brightGray p-12  max-[640px]:p-8">
                        <div className="flex justify-between items-center max-[640px]:items-start max-[640px]:flex-col">
                            <div className="flex items-center justify-start">
                                ...
                                <h1 className="h1 pl-5">Delete Event</h1>
                            </div>
                        ...
                        <p className="text-base text-[#2E363F] font-normal pt-10 pb-12">Are you sure want to delete this event permanently?</p>
