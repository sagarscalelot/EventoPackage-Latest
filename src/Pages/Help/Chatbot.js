                            ...
                            <div className="shadow-lg rounded-md overflow-hidden h-full">
                                ...
                                <div className="p-5 py-3.5 bg-white flex items-center">
                                    ...
                                    <div className="w-full pl-3.5">
                                        <h3 className="text-sm">{intl.formatMessage({ id: "MARK JECNO" })}</h3>
                                ...
                                <div className="chat-holder">
                                    <div className="text-massage right-massage">
                                        <p>{intl.formatMessage({ id: "I NEED YOUR HELP" })} <span>{intl.formatMessage({ id: "2:55PM" })}</span></p>
                                    ...
                                    <div className="line-main">
                                        <hr />
                                        <span>{intl.formatMessage({ id: "TODAY" })}</span>
                                    </div>
                                </div>
                                {/* <!-- chat-input --> */}
                                <div className="p-5 bg-white flex items-center space-x-3">
                                    ...
                                    <label className="block w-full">
                                        <input type="text" placeholder={`${intl.formatMessage({ id: "TYPE HERE..." })}`} className="w-full outline-none" onChange={(e) => setInput(e.target.value)} />
                                    </label>
