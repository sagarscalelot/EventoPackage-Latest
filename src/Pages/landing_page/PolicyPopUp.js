          ...
          <div className="bg-brightGray p-7 space-y-7">
            <div id="termsBox">
              ...
              <div className="space-y-3">
                <p className="text-sm font-normal">EVENTOPACKAGE PVT LTD (the “Company”) respects the privacy of its online visitors and customers of its products and services (including, but not limited to Evento Package) and complies with applicable laws for the protection of your privacy, including, without limitation, the European Union General Data Protection Regulation ("GDPR") and the Swiss and EU Privacy Shield Frameworks.</p>
              </div>
              ...
              <div className="space-y-3">
                <p className="text-sm font-normal">This privacy policy was last updated on 02 December 2022 ("Revision Date"). If you were a user before the Revision Date, it replaces the existing Privacy Policy. The Company reserves the right to change this policy at any time by notifying the users of the existence of a new privacy statement. This policy is not intended to and does not create any contractual or legal rights in or behalf of any party.</p>
              </div>
            </div>
          </div>
        </div>
