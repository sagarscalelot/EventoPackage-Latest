      ...
      <div className="space-y-7 h-full">
        ...
        <div className="w-full space-y-7">
          ...
          <div className="Accordions w-full space-y-5">
            ...
            <div className="Accordion_item">
              <h3 className="title_tab">
              {intl.formatMessage({ id: "REFERRAL EARN AND READING EARN" })}
                <span>
                  <i className="icon-plus"></i>
                  <i className="icon-minus text-[3px]"></i>
                </span>
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-7">-	{intl.formatMessage({ id: "YOU CAN REFER BY SMS, ON TELEGRAM, TWITTER, WHATSAPP, VIA E-MAIL, AND OTHER SOCIAL MEDIA APPS." })}</p>
                  ...
                  <h5 className="mt-3 pl-3">{intl.formatMessage({ id: "HOW CAN I EARN POINTS BY READING?" })}</h5>
                  <p className="pl-7">- {intl.formatMessage({ id: "EVERYONE CAN EARN COINS BY READING EVENT AND OFFER DETAILS, WHICH IS SET BY DEFAULT WITH OUR FAM SYSTEM." })}</p>
                </div>
              </div>
            </div>
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-3">{intl.formatMessage({ id: "USERS CAN GIVE RATINGS AND REVIEWS TO THE ORGANIZERS. ORGANIZERS AND USERS CAN SEE EACH OTHER'S RATINGS AND REVIEWS." })}</p>
                </div>
              </div>
            </div>
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-3">{intl.formatMessage({ id: "THE APP SUPPORTS MULTIPLE LANGUAGES WHICH CAN BE TRANSLATED AS PER NEEDED. THE ORGANIZERS CANNOT TRANSLATE THE LANGUAGE THOUGH." })}</p>
                  <h5 className="mt-3 pl-3">{intl.formatMessage({ id: "THE FOLLOWING LANGUAGES ARE AVAILABLE." })}</h5>
                  <p className="pl-3">{intl.formatMessage({ id: "ENGLISH, HINDI, SPANISH, FRENCH, BENGALI, RUSSIAN, PORTUGUESE, URDU, GERMAN, JAPANESE, MARATHI, TELEGU, WESTERN PUNJABI, TAMIL, TURKISH." })}</p>
                </div>
              </div>
            </div>
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-3">{intl.formatMessage({ id: "INDIAN RUPEES (INR), US DOLLAR (USD), EURO (EUR), JAPANESE YEN (JPY), BRITISH POUNDS (GBP), AUSTRALIAN DOLLARS (AUD), CANADIAN DOLLARS (CAD), NEW ZEALAND DOLLARS (NZD), SINGAPORE DOLLARS (SGD), HONG KONG DOLLARS (HKD), TURKISH LIRA (TRY), RUSSIAN RUBLE (RUB), SWISS FRANCS (CHF)." })}
                  </p>
                </div>
              </div>
            </div>
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-3">{intl.formatMessage({ id: "CUSTOMERS CAN EMAIL US ON" })} <b>help@eventopackage.com</b> {intl.formatMessage({ id: "ANYTIME TO SOLVE THEIR COMPLAINTS. THERE IS ALSO A CHATBOT AVAILABLE TO SOLVE THE DOUBTS IMMEDIATELY. AT LAST, CUSTOMERS CAN GO THROUGH THE FAQ SECTION TO KNOW MORE. AND ALSO AVAILABLE CALL ICON TO SUPPORT TEAM." })}</p>
                </div>
              </div>
            </div>
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  <p className="pl-7">- {intl.formatMessage({ id: "COIN REDEEM BY BANK OR BY PRODUCT" })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "BY BANK REDEEMING CAN BE DONE AFTER A COLLECTION OF 200 COINS." })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "IF YOU REDEEM THROUGH A BANK ACCOUNT, 5% BANK CHARGES AND GST APPLIED." })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "IF YOU WANT TO REDEEM BY PRODUCT THEN YOU CAN REDEEM AT THE TIME OF PAYMENT AND TRANSFER BY OUR SCANNER." })}</p>
                </div>
              </div>
            </div>
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-3">{intl.formatMessage({ id: "YOU CAN SHARE THE EVENT SERVICES LINK YOU LIKE WITH YOUR FRIENDS AND FAMILY THROUGH NUMEROUS SOCIAL MEDIAS." })}</p>
                  <h5 className="mt-3 pl-3">{intl.formatMessage({ id: "WHAT ARE THE SUBSCRIPTION OPTIONS AVAILABLE FOR EVENT ORGANIZERS?" })}</h5>
                  <p className="pl-7">- {intl.formatMessage({ id: "WHEN AN EVENT ORGANIZER REGISTERS FOR THE FIRST TIME, THEY CAN REGISTER 5 EVENTS FOR FREE, VALID FOR A YEAR. LATER, SUBSCRIPTION IS MANDATORY." })}</p>
                </div>
              </div>
            </div>
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-7">-	{intl.formatMessage({ id: "AFTER THE EVENT ENDS, THE INVOICE WILL BE MADE IN SAME DAYS. ONCE THE INVOICE IS MADE, PAYMENT MUST BE RELEASED IN 2-3 WORKING DAYS. BANK CHARGES MUST BE COLLECTED FROM THE CUSTOMERS. ALSO, IT CAN TAKE UP TO 3 BUSINESS DAYS FOR THE TRANSFER." })}</p>
            ...
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-5">-	{intl.formatMessage({ id: "COMPANY WILL SEND NOTIFICATION IN THE FOLLOWING CASES:" })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "WHEN EVENT STARTS AND END" })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "WHEN ANY PAYMENT IS MADE" })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "WHEN ANY GIFT ADDED IN THE LIST" })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "WHEN COIN TRANSACTION IS MADE" })}</p>
            ...
            <div className="inner_content" style={{ display: "none" }}>
              <div>
                ...
                <p className="pl-5">-	{intl.formatMessage({ id: "THE APP SENDS REMINDER IN FOLLOWING CASES:" })}</p>
                <p className="pl-7">- {intl.formatMessage({ id: "SMS REMINDERS IN CASE ANY INVOICE IS GENERATED" })}</p>
                <p className="pl-7">- {intl.formatMessage({ id: "WHEN ANY EVENT SERVICE IS BOOKED" })}</p>
                <p className="pl-7">- {intl.formatMessage({ id: "AT THE TIME OF SUBSCRIPTION AND EXPIRY OF SUBSCRIPTION" })} </p>
              </div>
            </div>
          </div>
            <div className="Accordion_item">
              <h3 className="title_tab">
              {intl.formatMessage({ id: "PRAMOTION" })}
                <span>
                  <i className="icon-plus"></i>
                  <i className="icon-minus text-[3px]"></i>
                </span>
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-5">- {intl.formatMessage({ id: "WHEN YOU CLICK ON THE PROMOTE BUTTON AND IT'S NOT WORKING, PLEASE EMAIL THE FOLLOWING THINGS TO US ON" })} <b>info@festumevento.com </b></p>
                  <p className="pl-7">- {intl.formatMessage({ id: "NAME OF YOUR DEVICE FROM WHICH YOU ARE USING THE APP." })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "UPLOAD SCREENSHOTS OF THE PROBLEM THAT IS OCCURRING ON THE SCREEN." })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "DESCRIBE THE PROBLEM IN 250 WORDS." })}</p>
                </div>
            ...
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-7">- {intl.formatMessage({ id: "THE GIFT SCREEN SHOWS THE BRAND COMPANY'S SHOPPING OFFER VOUCHER." })} </p>
                  ...
                  <p className="pl-5">- {intl.formatMessage({ id: "IF THE GIFT SCREEN OF THE APP IS NOT PROPERLY VISIBLE OR OFFLINE OFFER VOUCHER NOT DOWNLOADING, PLEASE EMAIL THE FOLLOWING THINGS TO US ON" })} <b>help@eventopackage.com </b> </p>
                  <p className="pl-7">{intl.formatMessage({ id: "NAME OF YOUR DEVICE FROM WHICH YOU ARE USING THE APP." })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "UPLOAD SCREENSHOTS OF THE PROBLEM THAT IS OCCURRING ON THE SCREEN." })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "DESCRIBE THE PROBLEM IN 250 WORDS." })}</p>
            ...
            <div className="Accordion_item">
              ...
              <div className="inner_content" style={{ display: "none" }}>
                <div>
                  ...
                  <p className="pl-7">- {intl.formatMessage({ id: "PLEASE EMAIL THE FOLLOWING THINGS TO US ON" })}  <b> help@eventopackage.com</b> </p>
                  <p className="pl-7">- {intl.formatMessage({ id: "NAME OF YOUR DEVICE FROM WHICH YOU ARE USING THE APP." })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "UPLOAD SCREENSHOTS OF THE PROBLEM THAT IS OCCURRING ON THE SCREEN." })}</p>
                  <p className="pl-7">- {intl.formatMessage({ id: "DESCRIBE THE PROBLEM IN 250 WORDS." })}</p>
                </div>
