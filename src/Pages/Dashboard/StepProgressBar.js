...
function StepProgressBar({ eventType }) {
    ...
    const placesProgressBarList = [`${intl.formatMessage({ id: "ADD PLACE" })}`, `${intl.formatMessage({ id: "ABOUT PLACE" })}`, `${intl.formatMessage({ id: "PERSONAL DETAILS" })}`, `${intl.formatMessage({ id: "PHOTOS & VIDEOS" })}`, `${intl.formatMessage({ id: "ADD SERVICE" })}`, `${intl.formatMessage({ id: "CAPACITY" })}`, `${intl.formatMessage({ id: "COMPANY DETAILS" })}`, `${intl.formatMessage({ id: "TERMS & CONDITIONS" })}`, `${intl.formatMessage({ id: "DISCOUNT" })}`, `${intl.formatMessage({ id: "CALENDAR" })}`];
