...
import EventPopUpTermsAndConditions from "../../../../component/Popups/DashboardPopup/EventPopUpTermsAndConditions";
import { tandcId, termsAndCondition } from "./termsAndVideoSlice";
...
const EventTermsAndConditions = () => {
  ...
  const getTandC = async () => {
    try {
      const response = await dispatch(tandcId(eventId)).unwrap()
            ...
            loading ?
              ...
              <div className="space-y-5">
                <div className="w-full space-y-2.5">
                  <h3>{intl.formatMessage({ id: "TERMS AND CONDITIONS" })}<span className="text-xs" style={{
                    color: '#20C0E8'
                      ...
                      <div className="w-full md:w-1/2 p-2">
                        <div className="w-full p-3.5 bg-white rounded flex items-center space-x-4">
                          ...
                          <input
                            ...
                            placeholder={intl.formatMessage({ id: "ENTER URL" })}
                            name="facebook"
                ...
                <div className="flex items-end">
                  ...
                  <span className="input-titel text-base ml-4">
                    {intl.formatMessage({ id: "ACCEPT YOUR" })} <button>{intl.formatMessage({ id: "TERMS AND CONDITIONS" })}</button>
                  </span>
                </div>
                <button
